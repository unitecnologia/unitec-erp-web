<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->whatsAppModalOpen): ?>
        ...
        <div class="erp-lookup-modal__window erp-orc-whatsapp-modal__window" role="dialog" aria-modal="true" aria-labelledby="erp-orc-whatsapp-title">
            ...
            <div class="erp-lookup-modal__body erp-orc-email-modal__body">
                ...
                <div class="erp-orc-email-modal__field">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['whatsAppTo'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="erp-orc-email-modal__field">
                    ...
                    <div class="erp-orc-email-modal__attachments">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->whatsAppPdfDisplay !== ''): ?>

                            <span class="erp-orc-email-modal__attachment is-selected">

                                <?php echo e($this->whatsAppPdfDisplay); ?>
...
<?php /**PATH C:\Projetos\unitec-erp-web\resources\views/filament/components/erp/orcamentos/whatsapp-modal.blade.php ENDPATH**/ ?>