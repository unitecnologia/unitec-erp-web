...
<div class="erp-nfe-actions erp-nf-forn-actions">
    <button
        ...
        data-erp-key="F2"
        <?php if($somenteLeituraAceitas): echo 'disabled'; endif; ?>
        title="<?php echo e($somenteLeituraAceitas ? 'Indisponível na aba Aceitas' : ''); ?>"
    >
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($this->statusFilter, ['aceita', 'gerou_compras'], true)): ?>
...
<?php /**PATH C:\Projetos\unitec-erp-web\resources\views/filament/components/erp/notas-fornecedores/action-bar.blade.php ENDPATH**/ ?>