<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->productPrecificacaoOpen): ?>
    <?php
        $p = $this->precificacao;
        $niveis = [
            ...
            <div class="erp-lookup-modal__body erp-prod-precificacao-modal__body">
                <div class="erp-prod-precificacao__produto">
                    <div class="erp-prod-precificacao__field">
                        ...
                        <input type="text" value="<?php echo e($p['codigo'] ?? ''); ?>" class="erp-pcad-form__input" readonly tabindex="-1">
                    </div>
                    <div class="erp-prod-precificacao__field">
                        <label>Cód. Barra</label>
                        <input type="text" value="<?php echo e($p['codigo_barras'] ?? ''); ?>" class="erp-pcad-form__input" readonly tabindex="-1">
                    </div>
                    <div class="erp-prod-precificacao__field">
                        <label>Referência</label>
                        <input type="text" value="<?php echo e($p['referencia'] ?? ''); ?>" class="erp-pcad-form__input" readonly tabindex="-1">
                    </div>
                    <div class="erp-prod-precificacao__field erp-prod-precificacao__field--grow">
                        <label>Descrição</label>
                        <input type="text" value="<?php echo e($p['descricao'] ?? ''); ?>" class="erp-pcad-form__input" readonly tabindex="-1">
                    </div>
                    <div class="erp-prod-precificacao__field erp-prod-precificacao__field--empresa">
                        <label>Empresa</label>
                        <input type="text" value="<?php echo e($p['empresa'] ?? ''); ?>" class="erp-pcad-form__input" readonly tabindex="-1">
                    </div>
                </div>
                ...
                <div class="erp-prod-precificacao__layout">
                    ...
                    <div class="erp-prod-precificacao__niveis">
                        ...
                        <div class="erp-prod-precificacao__niveis-grid">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $niveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <fieldset class="erp-prod-precificacao__box erp-prod-precificacao__box--<?php echo e($meta['class']); ?>">
                                    <legend><?php echo e($meta['label']); ?></legend>

                                    <div class="erp-prod-precificacao__row erp-prod-precificacao__row--dual">
                                        <label for="precif-<?php echo e($key); ?>-comissao">Comissão</label>
                                        <div class="erp-prod-precificacao__cell">
                                            <input
                                                id="precif-<?php echo e($key); ?>-comissao"
                                                type="text"
                                                wire:model="precificacao.niveis.<?php echo e($key); ?>.comissao"
                                                data-mask="percent-br"
                                                class="erp-pcad-form__input erp-pcad-form__input--num"
                                        ...
                                        <div class="erp-prod-precificacao__cell">
                                            <input
                                                id="precif-<?php echo e($key); ?>-comissao-rs"
                                                type="text"
                                                wire:model="precificacao.niveis.<?php echo e($key); ?>.comissao_rs"
                                                data-mask="money-br"
                                                class="erp-pcad-form__input erp-pcad-form__input--num"
                                    ...
                                    <div class="erp-prod-precificacao__row erp-prod-precificacao__row--dual">
                                        <label for="precif-<?php echo e($key); ?>-desconto">Desconto</label>
                                        <div class="erp-prod-precificacao__cell">
                                            <input
                                                id="precif-<?php echo e($key); ?>-desconto"
                                                type="text"
                                                wire:model="precificacao.niveis.<?php echo e($key); ?>.desconto"
                                                data-mask="percent-br"
                                                class="erp-pcad-form__input erp-pcad-form__input--num"
                                        ...
                                        <div class="erp-prod-precificacao__cell">
                                            <input
                                                id="precif-<?php echo e($key); ?>-desconto-rs"
                                                type="text"
                                                wire:model="precificacao.niveis.<?php echo e($key); ?>.desconto_rs"
                                                data-mask="money-br"
                                                class="erp-pcad-form__input erp-pcad-form__input--num"
                                    ...
                                    <div class="erp-prod-precificacao__row erp-prod-precificacao__row--dual">
                                        <label for="precif-<?php echo e($key); ?>-margem">Margem</label>
                                        <div class="erp-prod-precificacao__cell">
                                            <input
                                                id="precif-<?php echo e($key); ?>-margem"
                                                type="text"
                                                wire:model="precificacao.niveis.<?php echo e($key); ?>.margem"
                                                data-mask="percent-br"
                                                class="erp-pcad-form__input erp-pcad-form__input--num"
                                        ...
                                        <div class="erp-prod-precificacao__cell">
                                            <input
                                                id="precif-<?php echo e($key); ?>-sugerido"
                                                type="text"
                                                wire:model="precificacao.niveis.<?php echo e($key); ?>.sugerido"
                                                class="erp-pcad-form__input erp-pcad-form__input--num"
                                                readonly
                                                tabindex="-1"
                                    ...
                                    <div class="erp-prod-precificacao__row erp-prod-precificacao__row--compra erp-prod-precificacao__row--praticado">
                                        <label for="precif-<?php echo e($key); ?>-praticado">Praticado</label>
                                        <div class="erp-prod-precificacao__cell erp-prod-precificacao__span-valores">
                                            <input
                                                id="precif-<?php echo e($key); ?>-praticado"
                                                type="text"
                                                wire:model="precificacao.niveis.<?php echo e($key); ?>.praticado"
                                                data-mask="money-br"
                                                class="erp-pcad-form__input erp-pcad-form__input--num"
...
<?php /**PATH C:\Projetos\unitec-erp-web\resources\views/filament/components/erp/produtos/form/precificacao-modal.blade.php ENDPATH**/ ?>