    ...
    <section class="erp-produtos-form__section erp-produtos-form__section--class">
        ...
        <div class="erp-produtos-form__grid erp-produtos-form__grid--r2">
            <div class="erp-produtos-form__cell erp-produtos-form__cell--r2-tipo">
                ...
                <?php echo $__env->make('filament.components.erp.produtos.form.compact-select', [
                    'id' => 'pprod-tipo',
                    'field' => 'tipo_produto',
...
<?php /**PATH C:\Projetos\unitec-erp-web\resources\views/filament/components/erp/produtos/form/tabs/dados-basicos.blade.php ENDPATH**/ ?>