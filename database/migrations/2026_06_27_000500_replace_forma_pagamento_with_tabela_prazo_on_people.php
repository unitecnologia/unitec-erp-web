...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('people', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('tabela_prazo_id')->nullable()->after('dia_pgto');
            $table->index('tabela_prazo_id');
        });
    }
    ...
    {
        Schema::table('people', function (Blueprint $table) {
            $table->dropIndex(['tabela_prazo_id']);
            $table->dropColumn('tabela_prazo_id');
