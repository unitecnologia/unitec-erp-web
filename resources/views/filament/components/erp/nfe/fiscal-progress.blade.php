...
>
    ...
    <div class="erp-nfe-fiscal-progress__panel" wire:ignore data-erp-nfe-fiscal-progress-panel>
        ...
        <ol class="erp-nfe-fiscal-progress__steps">
            <li class="is-active" data-erp-nfe-fiscal-step data-step="0">Validando dados da NF-e</li>
            <li data-erp-nfe-fiscal-step data-step="1">Montando XML do documento</li>
            <li data-erp-nfe-fiscal-step data-step="2">Assinando digitalmente</li>
            <li data-erp-nfe-fiscal-step data-step="3">Enviando à SEFAZ (aguardando resposta)</li>
            <li data-erp-nfe-fiscal-step data-step="4">Processando autorização</li>
        </ol>
