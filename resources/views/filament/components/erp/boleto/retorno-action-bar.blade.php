<div class="erp-unidades-actions">
    <button type="button" wire:click="importarRetorno" class="erp-unidades-actions__btn" data-erp-key="F2">
        <span class="erp-unidades-actions__icon erp-unidades-actions__icon--new">↓</span>
        <span class="erp-unidades-actions__label"><kbd>F2</kbd> | Importar</span>
    </button>
