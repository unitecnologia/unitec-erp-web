@php
    ...
    $isDateSearch = in_array($filters['campo'] ?? 'cliente', ['data_emissao', 'data_saida'], true);
    ...
    $buildUrl = function (array $extra = []) use ($reportUrl, $filters): string {
        ...
        $params = array_filter([
            ...
            'status' => ($filters['status'] ?? 'aberta') !== 'aberta' ? $filters['status'] : null,
...
<head>
    ...
    <title>Visualizar — Listagem de NF-e</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        @media print {
            ...
            .nfe-list-doc__frame { border: none; padding: 0; }

        }

    </style>

    @include('reports.partials.nfe-listagem-document-styles')
        ...
        <div class="viewer__layout">
            ...
            <aside class="viewer__filters">
                ...
                <form method="get" action="{{ $reportUrl }}" id="report-filters-form">
                    ...
                    <div class="viewer__field">
                        ...
                        <select id="status" name="status">
                            ...
                            @foreach ($filterOptions['status'] as $value => $label)
                                ...
                                <option value="{{ $value }}" @selected(($filters['status'] ?? 'aberta') === $value)>{{ $label }}</option>
                    ...
                    <div class="viewer__field">
                        ...
                        <label for="campo">Localizar em</label>

                        <select id="campo" name="campo">

                            @foreach ($filterOptions['campo'] as $value => $label)

                                <option value="{{ $value }}" @selected(($filters['campo'] ?? 'cliente') === $value)>{{ $label }}</option>
            ...
            <div class="viewer__canvas">
                ...
                <div class="viewer__paper">
                    ...
                    @include('reports.partials.nfe-listagem-document-body')
