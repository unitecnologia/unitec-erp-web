...
(function initErpNoBrowserHints() {
    ...
    function isLockedField(element) {
        return Boolean(element?.closest?.('[data-erp-locked]'));
    }
    ...
    function fieldSignature(element) {
        return [
            ...
            element.getAttribute('wire:model.live.debounce.300ms') || '',
    ...
    function hardenField(element) {
        ...
        if (! element.hasAttribute('data-erp-stable-name') && element.dataset.erpNoAutofillName !== '1') {
