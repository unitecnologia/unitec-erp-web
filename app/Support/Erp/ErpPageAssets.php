...
class ErpPageAssets
{
    ...
    private const LIST_MODULE_STYLES = [
        ...
        'compras' => ['css/erp-form-ui.css', 'css/erp-produtos-form.css', 'css/erp-notas-fornecedores.css', 'css/erp-compras.css'],
        'analise-compras' => ['css/erp-os-form.css', 'css/erp-analise-compras.css'],
        ...
        'orcamentos' => ['css/erp-orcamentos.css', 'css/erp-form-ui.css', 'css/erp-nfe.css', 'css/erp-pdv.css', 'css/erp-fv-tela-venda.css', 'css/erp-orcamentos-form.css'],
        'ordens-servico' => ['css/erp-orcamentos.css', 'css/erp-form-ui.css'],
        'devolucoes-venda' => ['css/erp-orcamentos.css', 'css/erp-form-ui.css'],
        'devolucoes-compra' => ['css/erp-orcamentos.css', 'css/erp-form-ui.css', 'css/erp-devolucoes-compra.css'],
        ...
        'promocoes' => ['css/erp-estoque-menus.css', 'css/erp-promocoes.css'],
        'contas-caixa' => ['css/erp-estoque-menus.css', 'css/erp-contas-caixa.css'],
        'recibos' => ['css/erp-estoque-menus.css', 'css/erp-form-ui.css', 'css/erp-recibos.css'],
        ...
        'outras-saidas-movimento' => ['css/erp-os-form.css', 'css/erp-mov-saidas.css'],
        ...
        'operacoes-fiscais' => ['css/erp-os-form.css', 'css/erp-operacoes-fiscais.css'],
        ...
        'permissoes' => ['css/erp-os-form.css', 'css/erp-acesso.css', 'css/erp-form-ui.css'],
    ];
    ...
    private const FORM_MODULE_STYLES = [
        ...
        'orcamentos' => ['css/erp-nfe.css', 'css/erp-pdv.css', 'css/erp-fv-tela-venda.css', 'css/erp-orcamentos-form.css'],
