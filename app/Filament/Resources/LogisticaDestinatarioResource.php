...
use App\Filament\Resources\LogisticaDestinatarioResource\Pages;
...
class LogisticaDestinatarioResource extends Resource
{
    protected static ?string $model = LogisticaDestinatario::class;

    protected static ?string $slug = 'logistica-destinatarios';
    ...
    {
        return ErpAccess::currentCan('logistica_destinatarios.access');
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->recordActions([])
            ->toolbarActions([])
            ->emptyStateHeading('Nenhum destinatário encontrado');
    }

    public static function getPages(): array
    {
        return [
            'index' => Pages\ListLogisticaDestinatarios::route('/'),
        ];
    }
}
