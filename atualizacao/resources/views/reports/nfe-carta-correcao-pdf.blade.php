...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        h1, h2 { margin: 0; text-align: center; line-height: 1.35; }
        h1 { font-size: 14px; }
        ...
        .box { border: 1px solid #333; padding: 10px; margin: 10px 0; line-height: 1.5; }
        .box__title { font-weight: 700; margin-bottom: 6px; text-transform: uppercase; }
        .protocolo { font-size: 12px; font-weight: 700; text-align: center; word-break: break-all; margin: 6px 0; }
        .chave { font-size: 10px; line-height: 1.4; word-break: break-word; text-align: center; }
    </style>
</head>
<body>
