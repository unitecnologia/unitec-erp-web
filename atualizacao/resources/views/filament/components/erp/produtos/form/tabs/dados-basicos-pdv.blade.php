...
<div class="erp-pcad-form">
    ...
    <div class="erp-pcad-form__row">
        ...
        <div class="erp-prod-date-wrap erp-prod-date-wrap--inline">
            <input
                id="pprod-validade"
                type="date"
                wire:model.blur="data.validade"
                data-erp-native-date
                class="erp-pcad-form__input erp-pcad-form__input--validade erp-pcad-form__input--date"
                onclick="try{this.showPicker()}catch(e){}"
            >
            <span class="erp-prod-date-icon" aria-hidden="true"></span>
        </div>
        <label class="erp-pcad-form__label erp-pcad-form__label--inline" for="pprod-lote">Lote</label>
        <input
            id="pprod-lote"
            type="text"
            wire:model.blur="data.lote"
            maxlength="60"
            class="erp-pcad-form__input erp-pcad-form__input--lote"
