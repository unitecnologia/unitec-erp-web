...
>
    ...
    <div class="erp-comandos__body">
        ...
        <section class="erp-comandos__actions">
            <article @class(['erp-comandos__action', 'erp-comandos__action--cache', 'is-focus' => $this->foco === 'cache'])>
                <div class="erp-comandos__action-top">
                    ...
                    <div class="erp-comandos__action-text">
                        <h2>Limpar Cache</h2>
                        <p>Remove configuração, rotas, views e cache da aplicação. Use após atualização ou tela desatualizada.</p>
                    </div>
                </div>
                <button
                    type="button"
                    class="erp-comandos__btn erp-comandos__btn--primary"
                    wire:click="limparCache"
                    wire:loading.attr="disabled"
                    wire:target="limparCache,aquecerSistema"
                    @disabled($this->busy)
                >
                    <span wire:loading.remove wire:target="limparCache">Limpar agora</span>
                    <span wire:loading wire:target="limparCache">Limpando…</span>
                </button>
            </article>
            ...
            <article @class(['erp-comandos__action', 'erp-comandos__action--warm', 'is-focus' => $this->foco === 'aquecer'])>
                <div class="erp-comandos__action-top">
                    ...
                    <div class="erp-comandos__action-text">
                        ...
                        <p>Compila telas do menu e OPcache. Roda automaticamente ao iniciar o ERP; use aqui após &quot;Limpar cache&quot; ou reinício do PC.</p>
                    </div>
                </div>
                <button
                    type="button"
