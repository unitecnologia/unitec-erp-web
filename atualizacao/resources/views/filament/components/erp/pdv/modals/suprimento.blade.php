@if ($this->activeModal === 'suprimento')
    <div class="erp-pdv-modal" role="dialog" aria-labelledby="erp-pdv-suprimento-title">
        ...
        <div class="erp-pdv-modal__window erp-pdv-modal__window--form">
            <header class="erp-pdv-modal__header">
                <h2 id="erp-pdv-suprimento-title">Suprimento</h2>
            </header>
            ...
            <div class="erp-pdv-modal__body">
                <div class="erp-pdv-form erp-pdv-form--modal">
                    <label class="erp-pdv-form__field erp-pdv-form__field--full">
                        <span>Histórico</span>
                        <input type="text" wire:model="suprimentoForm.historico" class="erp-pdv-form__input">
                    </label>
                    ...
                    <label class="erp-pdv-form__field">
                        ...
                        <select wire:model="suprimentoForm.tipo_conta" class="erp-pdv-form__select">
                            <option value=""></option>
            ...
            <footer class="erp-pdv-modal__footer">
                <button type="button" wire:click="gravarSuprimento" class="erp-pdv-modal__btn erp-pdv-modal__btn--primary">
                    <kbd>F10</kbd> Gravar
                </button>
