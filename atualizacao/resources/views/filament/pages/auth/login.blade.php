<div class="unitec-login-root">
    ...
    @if ($showUpdatePrompt)
        <div class="unitec-update-prompt" role="dialog" aria-modal="true" aria-labelledby="unitec-update-prompt-title">
            <div class="unitec-update-prompt__card">
                ...
                <div class="unitec-update-prompt__actions">
                    <button
                        type="button"
                ...
                <p class="unitec-update-prompt__hint" wire:loading wire:target="aceitarAtualizacao">Aplicando arquivos… aguarde.</p>
            </div>
        </div>
        <style>
            ...
            .unitec-update-prompt__hint { margin-top: .85rem !important; font-size: .9rem; color: #64748b !important; }
        </style>
    @endif
