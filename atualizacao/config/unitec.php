...
return [
    ...
    */
    ...
    /*
    | Atualização remota — arquivos soltos (sem ZIP).
    | Manifest no branch GitHub update-files.
    */
    'update_manifest_url' => env(
        'UNITEC_UPDATE_MANIFEST_URL',
        'https://raw.githubusercontent.com/unitecnologia/unitec-erp-web/update-files/atualizacao/manifest.json'
    ),

    /** @deprecated Canal antigo — apontar para a pasta atualizacao no GitHub. */
