    ...
    <div class="erp-pdv-modal erp-pdv-modal--menu" role="dialog" aria-label="Opções do PDV">
        ...
        <div class="erp-pdv-options" id="erp-pdv-options-panel">
            ...
            <ul class="erp-pdv-options__list" role="menu">
                ...
                <li>
                    <button type="button" role="menuitem" wire:click="openVendasEsperaModal" @disabled(! $caixaAberto)>
                        <span class="erp-pdv-options__ico" aria-hidden="true">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M9 6v12M15 6v12"/></svg>
                        </span>
                        <span class="erp-pdv-options__txt">Vendas em espera</span>
                    </button>
                </li>
