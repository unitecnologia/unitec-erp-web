...
trait ManagesOrcamentoViewModal
{
    ...
    public function openOrcamentoView(int $orcamentoId): void
    {
        ...
        $this->viewModalHeader = [
            ...
            'cliente' => $orcamento->clienteDisplayNome() ?: '—',
            'cpf_cnpj' => $this->formatViewModalCpfCnpj($orcamento->clienteDisplayCpfCnpj() ?: null),
            'endereco' => $orcamento->clienteDisplayEndereco() ?: '—',
            'numero_end' => $orcamento->clienteDisplayNumero() ?: '—',
            'bairro' => $orcamento->clienteDisplayBairro() ?: '—',
            'cep' => $orcamento->clienteDisplayCep() ?: '—',
            'cidade' => $orcamento->clienteDisplayCidade() ?: '—',
            'uf' => $orcamento->clienteDisplayUf() ?: '—',
            'fone' => $orcamento->clienteDisplayFone() ?: '—',
            'whatsapp' => $orcamento->clienteDisplayWhatsapp() ?: '—',
