...
namespace App\Filament\Resources\RhCargoResource\Pages;
...
class ListRhCargos extends ListRecords
{
    ...
    protected static string $resource = RhCargoResource::class;
    ...
    {
        return '.erp-rh-cargos__search-text';
    }
    ...
    {
        return $this->applyErpListSelection(RhCargoResource::table($table));
    }
