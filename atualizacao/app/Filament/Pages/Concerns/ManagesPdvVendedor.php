    ...
    protected function notificarOperadorObrigatorio(): void
    {
        Notification::make()
            ...
            ->body(
                ...
                "1) Em RH → Funcionários, marque a aba Operador e vincule o usuário\n".
                "2) Confira empresas/caixas em Permissões / Usuários\n".
        ...
        if (! $vendedor || ! $vendedor->podeUsarTerminal($terminalId)) {
            Notification::make()
                ...
                ->body(
                    ...
                    "\nLibere o PDV em RH → Funcionários → aba Operador → PDVs liberados."
                )
                ->danger()
                ->send();
