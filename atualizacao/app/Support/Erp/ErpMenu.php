...
use App\Filament\Pages\ListaUpdatesPage;
...
class ErpMenu
{
    ...
    {
        return [
            static::link('Permissões / Usuários', PermissoesPage::getUrl(), permission: 'acesso.permissoes.manage'),
            static::sep(),
    ...
    protected static function estoqueItems(): array
    {
        return [
            ...
            static::group('Movimentações e Ajuste', [
                ...
                static::stub('Transferência de Estoque'),
                static::link('Outras Saídas/Movimento', OutrasSaidasMovimentoPage::getUrl(), permission: 'ajuste_estoque.access'),
            ]),
            static::sep(),
    ...
    protected static function comprasItems(): array
    {
        return [
            ...
            static::link('Análise e Sugestão de Compra', AnaliseComprasPage::getUrl(), permission: 'compras.access'),
    ...
    protected static function fiscalItems(): array
    {
        return [
            ...
            static::link('CFOP - Operações fiscais', OperacoesFiscaisPage::getUrl(), permission: 'cfops.access'),
    ...
    protected static function configuracoesItems(): array
    {
        return [
            ...
            static::group('Comandos', [
                ...
                static::link('Limpar Cache', url('/admin/comandos-sistema').'?foco=cache', permission: 'comandos.access'),
                static::link('Aquecer Sistema', url('/admin/comandos-sistema').'?foco=aquecer', permission: 'comandos.access'),
                static::link('Info do Sistema', url('/admin/comandos-sistema').'?foco=info', permission: 'comandos.access'),
            ]),
        ];
    }
    ...
    protected static function ajudaItems(): array
    {
        return [
            ...
            static::link('Lista de Updates', ListaUpdatesPage::getUrl()),
