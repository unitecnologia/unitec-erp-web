...
class VendasProdutosVendedoresReport extends AbstractTabularReport
{
    public function slug(): string
    {
        return 'vendas-produtos-vendedores';
    }

    public function title(): string
    {
        return 'VENDAS DE PRODUTOS — VENDEDORES';
    }
    ...
    public function build(Request $request): array
    {
        ...
        $rows = VendaItem::query()
            ...
            ->groupBy('vendas.vendedor_id', 'vendedores.nome', 'vendas.vendedor_nome', 'venda_itens.product_id', 'products.codigo', 'products.descricao')
