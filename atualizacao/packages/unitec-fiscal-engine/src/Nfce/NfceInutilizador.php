...
final class NfceInutilizador
{
    ...
    public function inutilizar(InutilizarNfceRequest $request): InutilizarNfceResponse
    {
        ...
        $endpoint = ScNfceEndpoints::inutilizacao($request->tpAmb);
        ...
        return new InutilizarNfceResponse(
            inutilizada: true,
